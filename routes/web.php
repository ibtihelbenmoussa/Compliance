...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('risks/{risk}/history', [App\Http\Controllers\RiskController::class, 'RiskHistory'])
    ->name('risks.history');

     Route::get('/risks/{risk}/kris', [App\Http\Controllers\KriController::class, 'KriByRisk'])
        ->name('risks.kris');
            Route::post('/kri-measures', [App\Http\Controllers\KriController::class, 'store'])
        ->name('risks.kris.store');
  ...
  Route::put('risk/{id}', [App\Http\Controllers\RiskController::class, 'update'])->name('risk.update');
    ...
    // ================= CONTROLS =================
        ...
        Route::get('controls/export', [ControleController::class, 'export'])
          ->name('controls.export');

        Route::get('controls', [ControleController::class, 'index'])
         ->name('controls.index');

        Route::get('controls/create', [ControleController::class, 'create'])
         ->name('controls.create');

        Route::post('controls', [ControleController::class, 'store'])
         ->name('controls.store');

// SETTINGS AVANT {control}
        Route::get('controls/settings', [App\Http\Controllers\ControlSettingsController::class, 'index'])
        ->name('controls.settings.index');


           Route::post('controls/settings/store', [App\Http\Controllers\ControlSettingsController::class, 'store'])
        ->name('controls.settings.store');



        Route::get('controls/{control}', [ControleController::class, 'show'])
        ->name('controls.show');

        Route::get('controls/{control}/edit', [ControleController::class, 'edit'])
         ->name('controls.edit');

        Route::put('controls/{control}', [ControleController::class, 'update'])
          ->name('controls.update');

        Route::delete('controls/{control}', [ControleController::class, 'destroy'])
     ...
     /////////////  plannings
             ...
             Route::get('planning/create', [App\Http\Controllers\PlannigController::class, 'create'])
          ->name('planning.create');

        Route::post('planning', [App\Http\Controllers\PlannigController::class, 'store'])
            ->name('planning.store');

        Route::get('planning/{planning}', [App\Http\Controllers\PlannigController::class, 'show'])
           ->name('planning.show');

        Route::get('planning/{planning}/edit', [App\Http\Controllers\PlannigController::class, 'edit'])
             ->name('planning.edit');

        Route::put('planning/{planning}', [App\Http\Controllers\PlannigController::class, 'update'])
              ->name('planning.update');

        Route::delete('planning/{planning}', [App\Http\Controllers\PlannigController::class, 'destroy'])
                ->name('planning.destroy');

        Route::get('plan/export', [App\Http\Controllers\PlannigController::class, 'export'])
