...
import { ChevronLeft, Calendar as CalendarIcon, Check, ChevronsUpDown } from 'lucide-react'
...
// Typage pour usePage (avec index signature obligatoire)
interface PageProps {
...
post(route('admin-settings.requirements.store'))
  }
