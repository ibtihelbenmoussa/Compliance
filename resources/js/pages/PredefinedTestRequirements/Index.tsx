...
export default function PredefinedTestsIndex({ tests }: Props) {
  ...
  const handleDelete = () => {
    if (!deleteId) return
    router.delete(route('predefined-tests-requirement.destroy', deleteId), {
      preserveScroll: true,
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const response = await fetch(`${route('predefined-tests-requirement.export')}?${params.toString()}`, {
        method: 'GET',
          ...
          return (
            <div className="flex justify-end gap-1">
              ...
              <Button
                ...
                onClick={() => router.visit(route('predefined-tests-requirement.edit', test.id))}
              >
    ...
    <AppLayout breadcrumbs={[{ title: 'Predefined Tests', href: '' }]}>
      ...
      <div className="container mx-auto space-y-6 py-6 px-4 md:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5">
          ...
          <Button asChild>
            <Link href={route('predefined-tests-requirement.create')}>
